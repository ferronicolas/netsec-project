    ...
    try:
        ...
        while True:
            ...
            if len(message) > 0:
                if message[0] == SIGN_IN_MESSAGE:
                ...
                elif (address in ip_port_association) and ip_port_association[address][0] == True:
                    ...
                    print 'We are ignoring your stupid message...'
            else:
    ...
    try:
        ...
        if is_timestamp_valid(timestamp):
            server_socket.sendto(
                make_current_users_message(ip_port_association[address][1], list_random_number),address)
        else:
